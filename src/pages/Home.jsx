...
const Home = () => {
  return (
    <>
      <SEO
        title="Zupiter – Neem Based Disinfectants & Hygiene Solutions in India"
        description="Zupiter provides medical-grade disinfectants infused with Neem and herbal extracts. Protect homes, clinics and businesses with powerful germ-killing hygiene solutions."
        keywords="neem disinfectant, herbal disinfectant India, hygiene products, hospital cleaners, germ protection"
        url="https://zupiterindia.in/"
      />
            ...
            <div className="bg-primary/5 rounded-[2.5rem] p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 border border-primary/10">
              <div className="flex-1">
                ...
                <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 max-w-lg">
                  Our range covers everything from hospital-grade floor cleaners
                  to gentle yet effective hand sanitizers designed for daily
                  use.
                </p>
                ...
                <Link
                  to="/products"
                  className="px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold rounded-xl hover:bg-slate-800 transition-all shadow-xl"
                >
                  Explore Our Range
                </Link>
              </div>
