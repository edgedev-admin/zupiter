...
const productsData = [
  {
    ...
    title: "DIS NEEM 24",
    description:
      "Advanced herbal floor cleaner and disinfectant powered by pure Neem extracts.",
    image: "/disNeem24.jpeg",
    tag: "Flagship",
    category: "Herbal Cleaners",
    features: [
      "99.9% Germ Protection",
      "24-Hour Active Shield",
      "Natural Neem Fragrance",
    ],
  },
  {
    id: 2,
    ...
    description:
      "High-concentration cleaning formula designed for hospitals and industrial spaces.",
  ...
  },
  {
    ...
    description:
      "100% pure steam-distilled Citronella oil for wellness and natural insect repellent.",
...
const Products = () => {
  ...
  return (
    <>
      <SEO
        title="Zupiter Products – Neem Disinfectants, Hospital Cleaners & Hygiene Essentials"
        description="Explore Zupiter's range of hygiene products including DIS NEEM 24 floor disinfectant, hospital-grade cleaners, essential oils and PPE designed for powerful germ protection."
        keywords="DIS NEEM 24, floor disinfectant, neem disinfectant, hospital cleaning products, hygiene solutions India"
        url="https://zupiterindia.in/products"
      />
        ...
        <header className="relative overflow-hidden pt-20 sm:pt-24 lg:pt-28 pb-12 sm:pb-16 lg:pb-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 dark:text-white mb-4 sm:mb-6">
              Advanced Hygiene for{" "}
              <span className="text-primary">Healthy Spaces</span>
            </h1>

            <p className="max-w-2xl mx-auto text-base sm:text-lg text-slate-600 dark:text-slate-400 mb-8">
              Based in Assam, Zupiter blends traditional herbal wisdom with
